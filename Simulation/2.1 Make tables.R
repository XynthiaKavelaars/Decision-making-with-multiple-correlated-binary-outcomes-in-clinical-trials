...
addtorow.conditions$command <- c("DGM & $\\delta_{1}$ & $\\delta_{2}$ & $\\rho_{\\theta_{j,1}, \\theta_{j,2}}$ & 
                           $\\theta_{E,1}$ & $\\theta_{E,2}$ & $\\phi_{E,11}$ &
                           $\\theta_{C,1}$ & $\\theta_{C,2}$ & $\\phi_{C,11}$ \\\\\n",
                                 rep("\\multicolumn{10}{c}{ }\\\\\n", 7))

#### 0.2 Print table ####
print(xtable(scenarios, caption="Data generating mechanisms (DGM) used in numerical evaluation of the framework.",
...
addtorow.SupRules$command <- c("DGM &
...
printbold(xtable(pSupRules, caption="P(Conclude superiority) for different data generating mechanisms (DGM) and decision rules.
	Bold-faced values indicate the conditions with least favorable values.",
      ...
      NA.string = " ", sanitize.text.function=I, 
...
addtorow.nStopRules$command <- c("DGM &  
                              \\multicolumn{1}{l}{Single} & 
                              \\multicolumn{1}{l}{Any} &
                              \\multicolumn{1}{l}{All} & 
                              \\multicolumn{1}{l}{C-E} & 
...
#### 1.2.2 Print table ####
printbold(xtable(nStopRules, caption="Average sample size to correctly conclude superiority for different data generating mechanisms (DGM) and decision rules.
	Bold-faced values indicate the lowest sample size per data generating mechanism.
Conditions with a hyphen should not result in treatment superiority.",
             label="tab:CompareRules_nStop", align="llrrrrrr", digits=c(1,1,rep(0,6))),
          which=pb.indices, type="latex",
          add.to.row=addtorow.nStopRules, caption.placement="top", 
          include.colnames=FALSE, include.rownames=FALSE, sanitize.text.function=I, 
          table.placement="htbp", booktabs=TRUE)
...
#### 1.3.2 Print table ####
print(xtable(BiasRules, caption="Average bias for different data generating mechanisms (DGM) and decision rules.",
             label="tab:CompareRules_bias", align="llrrrrrr"),
      na.string=" ",
      add.to.row=addtorow.BiasRules, caption.placement="top", 
      include.colnames=FALSE, include.rownames=FALSE, 
      sanitize.text.function=I, table.placement="htbp", booktabs=TRUE)
...
#### 2.1.2 Print table ####
print(xtable(pSup.Designs, caption="P(Conclude superiority) for different trial designs 
             (AD = adaptive design, FD = fixed design, SD = group sequential design) 
             and anticipated treatment differences ($\bm{\delta}^{n}$) after applying 
             the Compensatory decision rule with equal weights.",
...
addtorow.nStopDesigns$command <- c(
                             "DGM & \\multicolumn{2}{l}{AD} &
                             \\multicolumn{4}{l}{FD} &
                             \\multicolumn{3}{l}{SD}\\\\\n",
...
#### 2.2.2 Print table ####
print(xtable(nStop.Compare, caption="Average sample size to correctly conclude superiority for 
different trial designs (AD = adaptive design, FD = fixed design, SD = group sequential design) 
and anticipated treatment differences ($\bm{\delta}^{n}$) after applying the Compensatory decision
rule with equal weights. 
	Data generating mechanisms with a hyphen should not result in treatment superiority.",
...
addtorow.BiasDesigns$command <- c("DGM & \\multicolumn{2}{l}{AD} &
                               \\multicolumn{4}{l}{FD} &
                               \\multicolumn{3}{l}{SD}\\\\\n",
...
#### 2.3.2 Print table ####
print(xtable(bias.Designs, caption="Average bias for different trial designs 
             (AD = adaptive design, FD = fixed design, SD = group sequential design) 
             and anticipated treatment differences ($\bm{\delta}^{n}$) after applying the 
             Compensatory decision rule with equal weights.",
             label="tab:CompareDesigns_bias", align="llrp{0.01\\textwidth}rrrp{0.01\\textwidth}rrr"),
      na.string=" ",
      add.to.row=addtorow.BiasDesigns, caption.placement="top", 
      include.colnames=FALSE, include.rownames=FALSE, 
      sanitize.text.function=I, table.placement="htbp", booktabs=TRUE)
...
#### 3.1.2 Print table ####
print(xtable(pSup_Prior, caption="P(Conclude superiority) for six different prior specifications (see Table \\ref{tab:priors}) after applying the Compensatory decision rule with equal weights.",
...
addtorow.BiasPrior$command <- c("DGM &
                          \\multicolumn{1}{l}{1} &
                          \\multicolumn{1}{l}{2} & 
                          \\multicolumn{1}{l}{3} &
                          \\multicolumn{1}{l}{4} & 
...
#### 3.2.2 Print table ####
print(xtable(Bias_Prior, caption="Average bias for six different prior specifications (see Table \\ref{tab:priors}) after applying the Compensatory decision rule with equal weights.",
             label="tab:ComparePriors_Bias", align="llrrrrrr"),
      na.string=" ",
      add.to.row=addtorow.BiasPrior, caption.placement="top", 
      include.colnames=FALSE, include.rownames=FALSE,
      sanitize.text.function=I, table.placement="htbp", booktabs=TRUE)
